...
#define W9825G6KH_MR_BURST_LENGTH_1      ((uint16_t)0x0000)
#define W9825G6KH_MR_BURST_LENGTH_2      ((uint16_t)0x0001)
#define W9825G6KH_MR_BURST_LENGTH_4      ((uint16_t)0x0002)
#define W9825G6KH_MR_BURST_LENGTH_8      ((uint16_t)0x0003)
#define W9825G6KH_MR_BURST_TYPE_SEQUENTIAL   ((uint16_t)0x0000)
#define W9825G6KH_MR_BURST_TYPE_INTERLEAVED  ((uint16_t)0x0008)
#define W9825G6KH_MR_CAS_LATENCY_2       ((uint16_t)0x0020)
#define W9825G6KH_MR_CAS_LATENCY_3       ((uint16_t)0x0030)
#define W9825G6KH_MR_OPERATING_MODE_STANDARD ((uint16_t)0x0000)
#define W9825G6KH_MR_WRITEBURST_MODE_SINGLE  ((uint16_t)0x0200)
...
#define W9825G6KH_DEFAULT_CONFIG {            \
    ...
    .BurstLength = W9825G6KH_MR_BURST_LENGTH_4, \
    .BurstType = W9825G6KH_MR_BURST_TYPE_SEQUENTIAL, \
    .CASLatency = W9825G6KH_MR_CAS_LATENCY_2, \
    .OperatingMode = W9825G6KH_MR_OPERATING_MODE_STANDARD, \
    .WriteBurstMode = W9825G6KH_MR_WRITE_BURST_MODE_SINGLE, \
    .RefreshRate = 1542 \
}
 ...
 Default Configuration
#define W9825G6KH_DEFAULT_REFRESH_RATE   781      For 100MHz SD clock: (64ms * 100MHz) / 8192 - 20
#define W9825G6KH_DEFAULT_CAS_LATENCY    W9825G6KH_MR_CAS_LATENCY_2
#define W9825G6KH_DEFAULT_BURST_LENGTH   W9825G6KH_MR_BURST_LENGTH_1
...
#define W9825G6KH_DEFAULT_CONFIG {                       \
    ...
    .CASLatency = W9825G6KH_MR_CAS_LATENCY_2,            \
    .OperatingMode = W9825G6KH_MR_OPERATING_MODE_STANDARD, \
    .WriteBurstMode = 0x0000,                             ✅ Programmed burst  \
    .RefreshRate = 1542                                    ✅ For 100MHz  \
}
 Exported functions prototypes ---------------------------------------------
W9825G6KH_StatusTypeDef W9825G6KH_Init(SDRAM_HandleTypeDef *hsdram, W9825G6KH_InitTypeDef *Config);
W9825G6KH_StatusTypeDef W9825G6KH_DeInit(void);
...
W9825G6KH_StatusTypeDef W9825G6KH_ExitSelfRefresh(void);
 ...
 Status Functions
uint32_t W9825G6KH_GetSize(void);
uint32_t W9825G6KH_GetFreeMemory(void);
W9825G6KH_StatusTypeDef W9825G6KH_CheckAddress(uint32_t Address);
...
#define W9825G6KH_ROW_COUNT              4096     12-bit address: 2^12 = 4096
#define W9825G6KH_COLUMN_COUNT           256      8-bit address: 2^8 = 256
#define W9825G6KH_PAGE_SIZE_BYTES        1024     256 columns × 16-bit = 512 bytes

 Memory Address
#define W9825G6KH_BANK_ADDR              ((uint32_t)0xC0000000)
#define W9825G6KH_END_ADDR               (W9825G6KH_BANK_ADDR + (W9825G6KH_SIZE_MB * 1024 * 1024))

 Mode Register Definitions
#define W9825G6KH_MR_BURST_LENGTH_1      ((uint16_t)0x0000)
#define W9825G6KH_MR_BURST_LENGTH_2      ((uint16_t)0x0001)
#define W9825G6KH_MR_BURST_LENGTH_4      ((uint16_t)0x0002)
#define W9825G6KH_MR_BURST_LENGTH_8      ((uint16_t)0x0004)
#define W9825G6KH_MR_BURST_TYPE_SEQUENTIAL   ((uint16_t)0x0000)
#define W9825G6KH_MR_BURST_TYPE_INTERLEAVED  ((uint16_t)0x0008)
#define W9825G6KH_MR_CAS_LATENCY_2       ((uint16_t)0x0020)
#define W9825G6KH_MR_CAS_LATENCY_3       ((uint16_t)0x0030)
...
#define W9825G6KH_MR_WRITEBURST_MODE_SINGLE  ((uint16_t)0x0200)
 ...
 Default Configuration
#define W9825G6KH_DEFAULT_REFRESH_RATE   677      For 100MHz clock, 64ms refresh
#define W9825G6KH_DEFAULT_CAS_LATENCY    W9825G6KH_MR_CAS_LATENCY_2
#define W9825G6KH_DEFAULT_BURST_LENGTH   W9825G6KH_MR_BURST_LENGTH_1
...
typedef enum {
    ...
    W9825G6KH_ERROR     = 0x01,
    W9825G6KH_BUSY      = 0x02,
    W9825G6KH_TIMEOUT   = 0x03,     Changed from W9825G6KH_TIMEOUT to avoid conflict
    W9825G6KH_INVALID_PARAM = 0x04
} W9825G6KH_StatusTypeDef;
...
#define W9825G6KH_DEFAULT_CONFIG {                       \
    .TargetBank = FMC_SDRAM_CMD_TARGET_BANK1,            \
    .BurstLength = W9825G6KH_MR_BURST_LENGTH_1,          \
    .BurstType = W9825G6KH_MR_BURST_TYPE_SEQUENTIAL,     \
    .CASLatency = W9825G6KH_MR_CAS_LATENCY_2,            \
    .OperatingMode = W9825G6KH_MR_OPERATING_MODE_STANDARD, \
    .WriteBurstMode = W9825G6KH_MR_WRITEBURST_MODE_SINGLE, \
    .RefreshRate = W9825G6KH_DEFAULT_REFRESH_RATE        \
}
